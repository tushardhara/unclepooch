						...
						echo '
							<tr class="' . esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ) . '">
								<td class="product-name">' .
									'<div class="wd_product_item"><a href="'.get_permalink( $cart_item['product_id'] ).'">'
										.$_product->get_image().
									'</a>'.
									...
									'</div><p class="wd_product_title">'.apply_filters( 'woocommerce_cart_item_name', $_product->get_title(), $cart_item, $cart_item_key ) . '</p>' .
									'<p class="wd_product_number">'.apply_filters( 'woocommerce_checkout_item_quantity', '<strong class="product-quantity">&times; ' . $cart_item['quantity'] . '</strong>', $cart_item, $cart_item_key ) .'</p>'.
									'<p class="wd_product_excerpt">'.substr($_product->post->post_excerpt,0,60).'</p>'.
