...
?>	
	<p class="availability stock <?php echo esc_attr($_product_stock['class']);?>"><span class="wd_availability">availability:</span><span><?php echo esc_attr($_product_stock['availability']);?></span></p>	
<?php	
