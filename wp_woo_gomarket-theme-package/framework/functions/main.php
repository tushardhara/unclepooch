				...
				<div class="third-footer-area">
					<div class="container">
						<div class="payment span12">
							<div>
								<h3 class="payment_title">payment partner</h3>
								<ul>
									<li><img alt="visa" title ="visa" src="<?php echo $wd_data['wd_visa_image'] ?>" /></li>
									<li><a href="#"><img alt="master card" title="master card" src="<?php echo $wd_data['wd_master_card_image'] ?>" /></a></li>
									<li><a href="#"><img alt="express" title="express" src="<?php echo $wd_data['wd_american_express_image'] ?>" /></a></li>
									<li><a href="#"><img alt="paypal" title ="paypal" src="<?php echo $wd_data['wd_paypal_image'] ?>" /></a></li>
									<li><a href="#"><img alt="foo" title ="paypal" src="<?php echo $wd_data['wd_foo_image'] ?>" /></a></li>
								</ul>
							</div>
						</div>
						<div class="service span12">	
							<div>
								<h3 class="service_title">shipping service</h3>
								<ul>
									<li><img alt="z_service" title ="z service" src="<?php echo $wd_data['wd_z_image'] ?>" /></li>
									<li><img alt="fedex" title="fedex" src="<?php echo $wd_data['wd_fedex_image'] ?>" /></li>
									<li><img alt="ups" title="ups" src="<?php echo $wd_data['wd_ups_image'] ?>" /></li>
								<ul>
							</div>
						</div>
					</div>
