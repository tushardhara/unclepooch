...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/woocommerce.2.1.2.zip', // The plugin source
		...
		,array(
			...
			'source'   				=> get_stylesheet_directory() . '/theme/includes/plugins/wd_shortcode.1.0.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
